...
export default function EditEducDetails({ data, updateData, changeMode, initialData, updateMode }) {
    ...
    return (
        <div className='add-details'>
            <BasicTextFields label={'School'} onChange={handleNameInput} defaultValue={currentData.name} />
            <BasicTextFields label={'Degree'} onChange={handleDegreeInput} defaultValue={currentData.degree} />
            <div className='dates' >
                <div>
